...
(function () {
    ...
    Primitives.fillRect(renderingContext, 210, 5, 200, 100, 
            [0, 100, 255]);
    ...
    // A few NEW AND IMPROVED circles.
    ...
    //         [255, 0, 0], [255, 255, 0], [0, 200, 0], [0, 0, 100]);
    Primitives.circleTrig(renderingContext, 515, 315, 100, 
            [120, 0, 0], [0, 255, 0]);
    Primitives.circleTrig(renderingContext, 720, 315, 100, 
            [0, 0, 200], [0, 255, 0], [190, 140, 0]);
    Primitives.circleTrig(renderingContext, 925, 315, 100,
            [255, 0, 0], [255, 255, 0], [0, 200, 0], [0, 0, 100]);
